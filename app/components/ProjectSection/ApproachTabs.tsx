        ...
        {phases.map((phase) => {
          ...
          return (
            ...
            >
              ...
              {/* Right */}
              <div
                className={`relative mx-auto h-full max-h-[400px] min-h-[300px] w-full max-w-[500px] scale-x-50 opacity-0 delay-300 ${animation2} transition-all duration-300 ease-in-out`}
              >
                <TiltedWrapper
                  height="100%"
                  width="100%"
