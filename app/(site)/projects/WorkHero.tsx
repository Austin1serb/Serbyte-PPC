...
export const WorkHero: React.FC = () => {
  return (
    <div className="inside-container-large">
      <div className="flex flex-col gap-6 max-md:px-5.5 items-center">
        <h1 className="xs:text-5xl text-center relative z-5 text-4xl leading-[1] font-medium tracking-tight text-slate-900 sm:text-6xl lg:text-7xl">
        ...
        <AnimatedElement
          element="p"
          delay={0.6}
          className="max-w-xs text-sm text-center leading-tight tracking-tight text-slate-700 md:max-w-sm md:pr-4 md:text-base"
        >
