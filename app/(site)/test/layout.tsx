const layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="relative">
      ...
      <div className="z-50 fixed bottom-0 right-0 w-full h-fit bg-white rounded-lg px-4 py-2">
        <span className="absolute -top-6 left-2 text-sm text-gray-500">Layout.tsx (The Parent has Access)</span>
        <div className="text-sm text-blue-500">Active UI State Variables</div>
