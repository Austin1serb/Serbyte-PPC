...
export const H2: React.FC<HeadingProps<"h2">> = ({ children, ...rest }) => {
  return (
    <h2 {...rest} className={clsx("text-4xl leading-9 tracking-tighter text-slate-900 md:text-5xl md:leading-12 lg:text-6xl", rest.className)}>
      {children}
    </h2>
  )
}
...
export const H3: React.FC<HeadingProps<"h3">> = ({ children, ...rest }) => {
  return (
    <h3 {...rest} className={clsx("text-2xl leading-8 font-medium tracking-tight text-slate-700 md:text-3xl", rest.className)}>
      {children}
    </h3>
  )
}
...
export function Text({ as: Component = "p", size = "base", className = "", ...props }: TextProps) {
  ...
  return <Component {...props} className={`${sizeClasses[size]} text-slate-700 tracking-tight ${className}`} />
}
...
export function Typography({ as: Component = "article", size = "base", className = "", ...props }: TypographyProps) {
  ...
  return <Component {...props} className={`${sizeClasses[size]} ${className}`} />
}
